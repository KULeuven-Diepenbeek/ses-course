...
De [SESsy library](/extra/sessy) git repository bevat een [.travis.yml](https://github.com/KULeuven-Diepenbeek/sessylibrary/blob/master/.travis.yml) bestand dat de Travis server instrueert wat te doen op welk moment:
...
Gebruik [Gradle](/dependency-management/gradle) Tasks:
